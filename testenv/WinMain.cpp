...
wchar_t* g_TestString = L"zombot :D";
...
void test(const char* module) {
	...
	printf("base: %p, dos: %p, pe: %p, size: %d\n", base, dos, pe, size);
}

void testFunc(const char* str) {
	MessageBoxA(NULL, str, "This function belongs to the host process, not to ZHL", MB_ICONINFORMATION | MB_OK);
}
...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	(void)LoadLibrary("xinput9_1_0.dll");
